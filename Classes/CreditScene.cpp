...
{
	SimpleAudioEngine::getInstance()->playBackgroundMusic(_file["music"].asString().c_str(), true);
...
void CreditScene::changeBG()
{
	...
	auto seq = Sequence::create(in, delay, out, CallFunc::create(CC_CALLBACK_0(CreditScene::changeBG, this)), nullptr);
