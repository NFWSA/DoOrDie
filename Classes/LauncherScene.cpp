...
bool Launcher::init()
{
	...
	startBtn->setTitleFontName("Buxton Sketch");
	...
	_loadBtn->setTitleText("Load");
	_loadBtn->setTitleFontName("Buxton Sketch");
	...
	settingBtn->setTitleFontName("Buxton Sketch");
	...
	exitBtn->setTitleFontName("Buxton Sketch");
